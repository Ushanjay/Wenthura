...
public class VehicleController {
    ...
    public ResponseEntity<Vehicle> updateVehicle(@PathVariable(value = "id") Long vehicleId,
        ...
        vehicle.setVehCon(vehicleDetails.getVehCon());
        vehicle.setVehDriver(vehicleDetails.getVehDriver());
        vehicle.setVehOName(vehicleDetails.getVehOName());
        vehicle.setVehAddress(vehicleDetails.getVehAddress());
